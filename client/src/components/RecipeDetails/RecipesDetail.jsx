...
import { cleanData, getDetail, Remove } from '../../redux/actions'
import s from '../RecipeDetails/RecipesDetails.module.css'
  ...
  return (
    ...
    <Link to="/home"><span className={s.backButton}>Back </span></Link>
        ...
        <div className={s.score}>
            ...
            <h3 className={s.t}>Health score:{details.healthyScore } ✔</h3>
        </div>
        <div className={s.sum}>
